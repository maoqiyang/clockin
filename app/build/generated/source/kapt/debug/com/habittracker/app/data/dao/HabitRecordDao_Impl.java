...
public final class HabitRecordDao_Impl implements HabitRecordDao {
  ...
  public HabitRecordDao_Impl(@NonNull final RoomDatabase __db) {
    this.__db = __db;
    this.__insertionAdapterOfHabitRecord = new EntityInsertionAdapter<HabitRecord>(__db) {
      @Override
      @NonNull
      protected String createQuery() {
        return "INSERT OR REPLACE INTO `habit_records` (`id`,`date`,`habitId`,`isCompleted`,`createdAt`,`updatedAt`) VALUES (nullif(?, 0),?,?,?,?,?)";
      }

      @Override
      protected void bind(@NonNull final SupportSQLiteStatement statement,
          @Nullable final HabitRecord entity) {
    ...
    this.__updateAdapterOfHabitRecord = new EntityDeletionOrUpdateAdapter<HabitRecord>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `habit_records` SET `id` = ?,`date` = ?,`habitId` = ?,`isCompleted` = ?,`createdAt` = ?,`updatedAt` = ? WHERE `id` = ?";
      }
    ...
    this.__preparedStmtOfDeleteRecordsByHabitId = new SharedSQLiteStatement(__db) {
      @Override
      @NonNull
  ...
  @Override
  public Object updateRecord(final HabitRecord record,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
  ...
  @Override
  public Object deleteRecordsByHabitId(final long habitId,
      final Continuation<? super Unit> $completion) {
    return CoroutinesRoom.execute(__db, true, new Callable<Unit>() {
      @Override
      @NonNull
      public Unit call() throws Exception {
        final SupportSQLiteStatement _stmt = __preparedStmtOfDeleteRecordsByHabitId.acquire();
        int _argIndex = 1;
        ...
        try {
          ...
          __preparedStmtOfDeleteRecordsByHabitId.release(_stmt);
        }
      }
    }, $completion);
  }
  ...
  @Override
  public LiveData<List<HabitRecord>> getRecordsByDate(final String date) {
    final String _sql = "SELECT * FROM habit_records WHERE date = ? ORDER BY habitId ASC";
    ...
    return __db.getInvalidationTracker().createLiveData(new String[] {"habit_records"}, false, new Callable<List<HabitRecord>>() {
      @Override
      @Nullable
      public List<HabitRecord> call() throws Exception {
        ...
        try {
          ...
          while (_cursor.moveToNext()) {
            ...
            _item = new HabitRecord(_tmpId,_tmpDate,_tmpHabitId,_tmpIsCompleted,_tmpCreatedAt,_tmpUpdatedAt);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  @Override
  public Object getRecordsByDateSync(final String date,
  ...
  @Override
  public Object getRecord(final long habitId, final String date,
      ...
      public HabitRecord call() throws Exception {
        ...
        try {
          ...
          if (_cursor.moveToFirst()) {
            ...
            final long _tmpUpdatedAt;
            _tmpUpdatedAt = _cursor.getLong(_cursorIndexOfUpdatedAt);
            _result = new HabitRecord(_tmpId,_tmpDate,_tmpHabitId,_tmpIsCompleted,_tmpCreatedAt,_tmpUpdatedAt);
          } else {
            _result = null;
          }
          return _result;
  ...
  @Override
  public Object getRecordsBetweenDates(final String startDate, final String endDate,
      final Continuation<? super List<HabitRecord>> $completion) {
    final String _sql = "SELECT * FROM habit_records WHERE date BETWEEN ? AND ? ORDER BY date ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 2);
    int _argIndex = 1;
    if (startDate == null) {
      _statement.bindNull(_argIndex);
  ...
  @Override
  public Object getRecordDates(final String startDate, final String endDate,
      final Continuation<? super List<String>> $completion) {
    final String _sql = "SELECT DISTINCT date FROM habit_records WHERE date BETWEEN ? AND ? ORDER BY date ASC";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 2);
    int _argIndex = 1;
    if (startDate == null) {
      _statement.bindNull(_argIndex);
  ...
  @Override
  public Object getCompletedCountByDate(final String date,
      final Continuation<? super Integer> $completion) {
    final String _sql = "SELECT COUNT(*) FROM habit_records WHERE date = ? AND isCompleted = 1";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (date == null) {
      _statement.bindNull(_argIndex);
  ...
  @Override
  public Object getTotalHabitsCountByDate(final String date,
      final Continuation<? super Integer> $completion) {
    final String _sql = "SELECT COUNT(DISTINCT habitId) FROM habit_records WHERE date = ?";
    final RoomSQLiteQuery _statement = RoomSQLiteQuery.acquire(_sql, 1);
    int _argIndex = 1;
    if (date == null) {
      _statement.bindNull(_argIndex);
